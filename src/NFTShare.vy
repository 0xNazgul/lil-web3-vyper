...
@custom:contract-name NFTShare
@license GNU Affero General Public License v3.0
@author 0xNazgul
@notice ERC20 token representing a share of an ERC721
@notice A modified version of Snekmate's ERC20
"""
...
@external
def setup(name_: String[25], symbol_: String[5], decimals_: uint8, mint_supply: uint256, mint_to: address):
    """
    ...
    self.symbol = symbol_
    self.decimals =  decimals_    
    self._mint(mint_to, mint_supply)
